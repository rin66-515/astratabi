      ...
      <motion.div className={styles.pageFrame} key={screenKey} {...motionProps}>
        {debugOpen
          ...
          : <>
            ...
            {opened && game.screen === 'annual-report' && <AnnualReportPage language={game.language} stats={game.stats} flags={game.flags} history={game.history} onContinue={game.completeAnnualReport} />}
